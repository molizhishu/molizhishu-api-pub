/**
 * Environment-backed configuration for the Vue-stack Node.js API demo.
 * The token is intentionally server-only and must never be exposed to browsers.
 */
export const config = {
  serviceName: env('SERVICE_NAME', 'molizhishu-api-pub-vue-node'),
  port: Number(env('APP_PORT', '18087')),
  db: {
